...
import { form_add } from '../../../model/form_add';
...
class AddRooms extends Component {
    constructor(props) {
        super(props);
        const _form = Object.assign({}, form_add);
        this.state = {
            room: _form
        }
        // console.log('add constructor', this.state);
    }
    ...
    submit = () => {
        ...
        this.props.dispatch(create(params)).then(data => {
                ...
                <ImageBackground source={images.bg} resizeMode="cover" style={styles.image}>
                    <View style={styles.row}>
                        ...
                        <View style={styles.right}>
                            ...
                            { this.state.room.errors.name.required &&
                            <Error>Name is required</Error>
                            }
                            { this.state.room.errors.name.maxLength &&
                    ...
                    <View style={styles.row}>
                        ...
                        <View style={styles.right}>
                            ...
                            { this.state.room.errors.price_day.required &&
                            <Error>Price is required</Error>
                            }
                            { this.state.room.errors.price_day.maxLength &&
                            <Error>Max length exceeded</Error>
                            }
                            { this.state.room.errors.price_day.isNumber &&
                    ...
                    <View style={styles.row}>
                        ...
                        <View style={styles.right}>
                            ...
                            { this.state.room.errors.price_hour.required &&
                            <Error>Price is required</Error>
                            }
                            { this.state.room.errors.price_hour.maxLength &&
                            <Error>Max length exceeded</Error>
                            }
                            { this.state.room.errors.price_hour.isNumber &&
                            <Error>Price is number</Error>
                            }
                        </View>
                    </View>
                    <View style={styles.row_bt}>
                        <TouchableOpacity style={this.state.room.isSubmit ? styles.btCreate : styles.btCreate_disable}
                         disabled={!this.state.room.isSubmit} onPress={this.submit}>
                            <Text style={styles.btTitle}>Create</Text>
                        </TouchableOpacity>
                    </View>
                </ImageBackground>
            </SafeAreaView>
...
export default connect(mapStateToProps)(AddRooms);